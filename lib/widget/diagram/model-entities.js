 ...
 * @property {string|null} kind        - NODE_KIND enum value for semantic rendering, or null.
 * @property {number|null} groupId     - Parent group box ID for cycle diagrams, or null.
 ...
 * @property {number|null}  density        - Stream animation fill fraction (0.0-1.0).
 * @property {boolean}      backEdge       - True if this is a back-edge (cycle/decision).
 */
