 ...
 *
 * mousedown on a box starts the drag; screen-level mouse events
 * track movement; mouseup ends it.
 */
...
Diagram.prototype._bindDrag = function _bindDrag() {
  ...
  this.on('mousedown', function onMouseDown(mouse) {
    ...
    /*
     * Guard: skip when a drag is already active.
     *
     ...
     */
    if (self._dragBoxId != null) return;
    ...
    /*
     * Only start drag on box interior or border hits.
