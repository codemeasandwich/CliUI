...
/** Standard box top-left corners (light, rounded, heavy, double). */
var TOP_LEFT_CORNERS = new Set(['\u250C', '\u256D', '\u250F', '\u2554']); // ┌ ╭ ┏ ╔

/** Standard box top-right corners (light, rounded, heavy, double). */
var TOP_RIGHT_CORNERS = new Set(['\u2510', '\u256E', '\u2513', '\u2557']); // ┐ ╮ ┓ ╗

/** Standard box bottom-left corners (light, rounded, heavy, double). */
var BOTTOM_LEFT_CORNERS = new Set(['\u2514', '\u2570', '\u2517', '\u255A']); // └ ╰ ┗ ╚

/** Standard box bottom-right corners (light, rounded, heavy, double). */
var BOTTOM_RIGHT_CORNERS = new Set(['\u2518', '\u256F', '\u251B', '\u255D']); // ┘ ╯ ┛ ╝

/**
 * Maps a top-left corner character to its base border style name.
 * Used by the parser to classify detected boxes by border style.
 *
 * Note: ┌ and ╭ need further disambiguation by checking the horizontal
 * character (dashed vs solid) — see parser-boxes.js.
 */
var CORNER_TO_STYLE = new Map([
  ['\u250C', 'light'],    // ┌ → light (or dashed — disambiguated by horizontal char)
  ['\u256D', 'rounded'],  // ╭ → rounded (or currentWork — disambiguated by horizontal char)
  ['\u250F', 'heavy'],    // ┏ → heavy (or dashedHeavy — disambiguated by horizontal char)
  ['\u2554', 'double']    // ╔ → double
]);
...
var HORIZONTAL_CHARS = new Set([
  ...
  '\u2501', // ━  heavy horizontal
  '\u2550', // ═  double horizontal
  '\u254C', // ╌  light dashed horizontal (dashed charset)
  '\u254D', // ╍  heavy dashed horizontal (current-work / dashedHeavy)
...
var VERTICAL_CHARS = new Set([
  ...
  '\u2503', // ┃  heavy vertical
  '\u2551', // ║  double vertical
  '\u254E', // ╎  light dashed vertical (dashed charset)
  '\u254F', // ╏  heavy dashed vertical (dashedHeavy charset)
...
module.exports = {
  ...
  CORNER_TO_STYLE:       CORNER_TO_STYLE,
