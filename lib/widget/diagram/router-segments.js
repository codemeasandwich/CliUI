...
/**
 * Map a port side to the exit direction for a connector departing
 * from that port.
 *
 * A connector leaving from the RIGHT side of a box exits rightward,
 * so the source arrow points RIGHT (away from the box, indicating
 * flow direction).
 *
 * This is the inverse of sideToArrowDir — entry arrows point inward,
 * exit arrows point outward.
 *
 * @param {string} side
 * @returns {string}
 */
function sideToExitDir(side) {
  switch (side) {
