...
Line.prototype.setData = function(data) {
  ...
  var maxPadding = getMaxXLabelPadding(this.options.numYLabels, this.options.wholeNumbersOnly, this.options.abbreviate, minY);
  ...
  var yLabelIncrement = (getMaxY()-minY)/this.options.numYLabels;
  ...
  for (var h=0; h<data.length; h++) {
    drawLine(data[h].y, data[h].style, minY);
  }
