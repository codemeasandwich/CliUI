...
Tree.prototype.focus = function() {
  // Guard against infinite loop - only focus if not already focused
...
Tree.prototype.render = function() {
  // Note: Removed redundant focus() call that caused infinite loop (#219)
  // If rows is already focused, no need to call focus() again during render
